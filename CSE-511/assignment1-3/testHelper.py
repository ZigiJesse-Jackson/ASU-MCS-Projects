...
def createDB(dbname='dds_assignment'):
    ...
    con = getOpenConnection(password='jonboy76')
...
def delete_db(dbname):
    con = getOpenConnection(dbname = 'postgres', password='jonboy76')
    con.set_isolation_level(psycopg2.extensions.ISOLATION_LEVEL_AUTOCOMMIT)
    cur = con.cursor()
...
def getOpenConnection(user='postgres', password='jonboy76', dbname='postgres'):
