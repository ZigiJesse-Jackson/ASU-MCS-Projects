...
class CustomerMessage(_message.Message):
    ...
    interface: Interface
    amount: int
    def __init__(self, id: _Optional[int] = ..., interface: _Optional[_Union[Interface, str]] = ..., amount: _Optional[int] = ...) -> None: ...

class BranchMessage(_message.Message):
    __slots__ = ("interface", "amount")
    INTERFACE_FIELD_NUMBER: _ClassVar[int]
    AMOUNT_FIELD_NUMBER: _ClassVar[int]
    interface: Interface
    amount: int
    def __init__(self, interface: _Optional[_Union[Interface, str]] = ..., amount: _Optional[int] = ...) -> None: ...
